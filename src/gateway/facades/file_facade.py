...
from protocols import FileFacadeProtocol, FileServiceProtocol


class FileFacade(FileFacadeProtocol):
    ...
    async def initiate_upload(
        ...
        return await self._file_service.initiate_upload(data)

    async def complete_upload(self, data: file_dto.CompleteUploadDTO) -> None:
        await self._file_service.complete_upload(data)
